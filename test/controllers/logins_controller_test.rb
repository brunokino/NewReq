...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { admin: @login.admin, manager: @login.manager, name: @login.name, password: @login.password, username: @login.username }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { admin: @login.admin, manager: @login.manager, name: @login.name, password: @login.password, username: @login.username }
    assert_redirected_to login_path(assigns(:login))
  end
